...
public class AcademicCoordinatorHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_academic_coordinator_home);
        ...
        tvWelcomeName.setText(prefs.getString("name", "Coordinator"));
